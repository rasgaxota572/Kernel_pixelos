...
if [ ! -f "$CLANG_DIR/bin/clang-14" ]; then
    ...
    pushd $CLANG_DIR > /dev/null
        curl -LJOk https://android.googlesource.com/platform/prebuilts/clang/host/linux-x86/+archive/refs/tags/android-12.1.0_r22/clang-r416183b1.tar.gz
    tar xf android-12.1.0_r22-clang-r416183b1.tar.gz
    rm android-12.1.0_r22-clang-r416183b1.tar.gz
    echo "Cleaning up..."
    popd > /dev/null
fi
